...
public class WebSecurity {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("https://homebanking-production-fbbd.up.railway.app","http://localhost:3000","https://thunderous-banoffee-41ed7e.netlify.app","https://dazzling-quokka-9b47fc.netlify.app"));
